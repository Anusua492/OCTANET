...
img = Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
...
def display_func():
    ...
    img1 =Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
    ...
    message.pack()
    text = Label(display_win, text='AB ATM', font=tim40, fg='#7FFF00')
    text.pack()
...
def question_func():
    ...
    img2 =Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
...
def withdrawal_func():
    ...
    img3 =Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
...
def balance_func():
    ...
    img4 =Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
    ...
    message.pack()
    text = Label(balance_win, text='AB ATM', font=tim40, fg='red')
    text.pack()
...
def message_func():
    ...
    img5 =Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
    ...
    message.pack()
    text = Label(win2, text='AB ATM', font=tim40, fg='red')
    text.pack()
...
def change_pin_func():
    ...
    img6 =Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
...
def option_func():
    ...
    img7 =Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
...
def enter_pin():
    ...
    img8 =Image.open('C:\\Users\\KIIT\\Documents\\OCTANET\\atm.jpg')
...
title_label = Label(win, text='AB ATM', font=tim40, fg='#FFD700', bg='#009ACD')              
